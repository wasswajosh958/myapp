...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(6) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `savings_goals` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `userId` INTEGER NOT NULL, `name` TEXT NOT NULL, `targetAmount` REAL NOT NULL, `currentAmount` REAL NOT NULL, `currency` TEXT NOT NULL, `modeId` INTEGER NOT NULL)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '9788823f749d10496d7eb86e94f32559')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        if (!_infoTransactions.equals(_existingTransactions)) {
          return new RoomOpenHelper.ValidationResult(false, "transactions(ug.ac.ndejje.myapp.resources.Transaction).\n"
                  + " Expected:\n" + _infoTransactions + "\n"
        ...
        if (!_infoCategories.equals(_existingCategories)) {
          return new RoomOpenHelper.ValidationResult(false, "categories(ug.ac.ndejje.myapp.resources.Category).\n"
                  + " Expected:\n" + _infoCategories + "\n"
                  + " Found:\n" + _existingCategories);
        }
        ...
        if (!_infoAccounts.equals(_existingAccounts)) {
          return new RoomOpenHelper.ValidationResult(false, "accounts(ug.ac.ndejje.myapp.resources.AccountEntity).\n"
                  + " Expected:\n" + _infoAccounts + "\n"
                  + " Found:\n" + _existingAccounts);
        }
        ...
        if (!_infoBudgets.equals(_existingBudgets)) {
          return new RoomOpenHelper.ValidationResult(false, "budgets(ug.ac.ndejje.myapp.resources.BudgetEntity).\n"
                  + " Expected:\n" + _infoBudgets + "\n"
                  + " Found:\n" + _existingBudgets);
        }
        ...
        if (!_infoRecurringTransactions.equals(_existingRecurringTransactions)) {
          return new RoomOpenHelper.ValidationResult(false, "recurring_transactions(ug.ac.ndejje.myapp.resources.RecurringTransaction).\n"
        ...
        if (!_infoAiConversations.equals(_existingAiConversations)) {
          return new RoomOpenHelper.ValidationResult(false, "ai_conversations(ug.ac.ndejje.myapp.resources.AIConversation).\n"
        ...
        if (!_infoCrashLogs.equals(_existingCrashLogs)) {
          return new RoomOpenHelper.ValidationResult(false, "crash_logs(ug.ac.ndejje.myapp.resources.CrashLog).\n"
                  + " Expected:\n" + _infoCrashLogs + "\n"
                  + " Found:\n" + _existingCrashLogs);
        }
        ...
        if (!_infoAnalyticsEvents.equals(_existingAnalyticsEvents)) {
          return new RoomOpenHelper.ValidationResult(false, "analytics_events(ug.ac.ndejje.myapp.resources.AnalyticsEvent).\n"
        ...
        if (!_infoUserProfile.equals(_existingUserProfile)) {
          return new RoomOpenHelper.ValidationResult(false, "user_profile(ug.ac.ndejje.myapp.resources.UserProfile).\n"
                  + " Expected:\n" + _infoUserProfile + "\n"
        ...
        if (!_infoNotifications.equals(_existingNotifications)) {
          return new RoomOpenHelper.ValidationResult(false, "notifications(ug.ac.ndejje.myapp.resources.NotificationEntity).\n"
                  + " Expected:\n" + _infoNotifications + "\n"
        ...
        if (!_infoUtilities.equals(_existingUtilities)) {
          return new RoomOpenHelper.ValidationResult(false, "utilities(ug.ac.ndejje.myapp.resources.UtilityEntity).\n"
                  + " Expected:\n" + _infoUtilities + "\n"
                  + " Found:\n" + _existingUtilities);
        }
        ...
        _columnsSavingsGoals.put("userId", new TableInfo.Column("userId", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsSavingsGoals.put("currency", new TableInfo.Column("currency", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsSavingsGoals.put("modeId", new TableInfo.Column("modeId", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoSavingsGoals.equals(_existingSavingsGoals)) {
          return new RoomOpenHelper.ValidationResult(false, "savings_goals(ug.ac.ndejje.myapp.resources.SavingsGoal).\n"
                  + " Expected:\n" + _infoSavingsGoals + "\n"
                  + " Found:\n" + _existingSavingsGoals);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "9788823f749d10496d7eb86e94f32559", "36ae1a0b16ac64ecb53282d16a3280e1");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "transactions","categories","accounts","budgets","recurring_transactions","ai_conversations","crash_logs","analytics_events","user_profile","notifications","utilities","savings_goals");
  }
