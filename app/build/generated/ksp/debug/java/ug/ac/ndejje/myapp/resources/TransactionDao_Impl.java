  ...
  public TransactionDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTransaction = new EntityInsertionAdapter<Transaction>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `transactions` (`id`,`userId`,`title`,`category`,`amountValue`,`date`,`time`,`isExpense`,`isPending`,`accountId`,`modeId`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      public List<Transaction> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            final double _tmpAmountValue;
            _tmpAmountValue = _cursor.getDouble(_cursorIndexOfAmountValue);
            ...
            final int _tmp_1;
            _tmp_1 = _cursor.getInt(_cursorIndexOfIsPending);
            _tmpIsPending = _tmp_1 != 0;
